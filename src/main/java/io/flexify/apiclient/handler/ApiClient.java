...
import io.flexify.apiclient.handler.auth.Authentication;
import io.flexify.apiclient.handler.auth.HttpBasicAuth;
...
public class ApiClient {
  ...
  protected String basePath = "https://api.flexify.io";
  ...
  public ApiClient() {
    ...
    setUserAgent("Swagger-Codegen/2.12.14-SNAPSHOT/java");
