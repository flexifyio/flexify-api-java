...
public class PublicAuthenticationConfiguration {
   ...
   * @return configured
  **/
  @ApiModelProperty(example = "false", value = "Specifics if credentials are configured on a single user mode")
  ...
  **/
  @ApiModelProperty(example = "false", value = "In the single user mode only one user account is possible")
