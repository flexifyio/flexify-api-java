...
public class EndpointStorageAccountSettings {
  ...
  public EndpointStorageAccountSettings createNewBucketsIn(String createNewBucketsIn) {
   ...
   /**
   * Region where new buckets will be created if not specified in reqeust. Set to null to create new buckets in a default region.
   * @return createNewBucketsIn
  **/
  @ApiModelProperty(value = "Region where new buckets will be created if not specified in reqeust. Set to null to create new buckets in a default region.")
