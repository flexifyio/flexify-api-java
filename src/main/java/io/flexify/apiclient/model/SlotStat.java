...
public class SlotStat {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activeEngines, activeStreams, bytesFailed, bytesNotMatchingPattern, bytesProcessed, bytesSkipped, bytesUploaded, dstRegion, finished, objectsFailed, objectsNotMatchingPattern, objectsProcessed, objectsSkipped, objectsUploaded, processingObjectsPerSecond, retried, srcRegion, started, state, totalUpload, uploadingBytesPerSecond, uploadingObjectsPerSecond);
  }
