...
public class SlotStat {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activeEngines, activeStreams, bytesFailed, bytesNotMatchingPattern, bytesProcessed, bytesSkipped, bytesUploaded, finished, objectsFailed, objectsNotMatchingPattern, objectsProcessed, objectsSkipped, objectsUploaded, processingObjectsPerSecond, retried, started, state, uploadingBytesPerSecond, uploadingObjectsPerSecond);
  }
