...
public class User {
  ...
  **/
  ...
  public User deleteRequested(DateTime deleteRequested) {
   ...
   /**
   * Time when user resueted to delete account
   * @return deleteRequested
  **/
  @ApiModelProperty(value = "Time when user resueted to delete account")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(account, deleteRequested, id, org, profile, registered, roles, state, username);
  }
