...
public class MappingStat {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activeEngines, activeSlots, activeStreams, bytesFailed, bytesNotMatchingPattern, bytesProcessed, bytesSkipped, bytesUploaded, cleanup, estimated, finished, initialBytes, initialObjects, objectsFailed, objectsNotMatchingPattern, objectsProcessed, objectsSkipped, objectsUploaded, processingObjectsPerSecond, progress, retried, started, state, step, uploadingBytesPerSecond, uploadingObjectsPerSecond);
  }
