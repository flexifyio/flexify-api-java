...
public class StorageAccountSettings {
  ...
  **/
  ...
  public StorageAccountSettings refreshStoragesStat(Boolean refreshStoragesStat) {
   ...
   /**
   * Indicates if statistics for each bucket/container should be calculated on refresh
   * @return refreshStoragesStat
  **/
  @ApiModelProperty(value = "Indicates if statistics for each bucket/container should be calculated on refresh")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(anonymous, credential, customEndpoint, identity, name, refreshIntervalSec, refreshStoragesStat, useSsl);
  }
