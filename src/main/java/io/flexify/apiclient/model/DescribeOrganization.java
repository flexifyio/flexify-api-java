...
public class DescribeOrganization {
  ...
  public DescribeOrganization id(Long id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public DescribeOrganization name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DescribeOrganization describeOrganization = (DescribeOrganization) o;
    return Objects.equals(this.id, describeOrganization.id) &&
        Objects.equals(this.name, describeOrganization.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeOrganization {\n");
