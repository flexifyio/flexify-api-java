...
public class MigrationSettings {
  ...
  **/
  ...
  public MigrationSettings maxActiveSlots(Integer maxActiveSlots) {
   ...
   /**
   * Maximum number of slots that can be migrated simultaneously (experimental)
   * @return maxActiveSlots
  **/
  @ApiModelProperty(example = "1", value = "Maximum number of slots that can be migrated simultaneously (experimental)")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(conflictResolution, enginesLocation, existingDataInDestination, maxActiveSlots, maxStreamsPerSlot, migrationMode, name, objectKeyFilter, skipIfHashMatches, slotsPerMapping);
  }
