...
public class StorageProvider {
  ...
  **/
  ...
  public StorageProvider dotEncode(String dotEncode) {
   ...
   /**
   * Indicates that the privder does not support dots in bucket names and how dots should be encoded
   * @return dotEncode
  **/
  @ApiModelProperty(value = "Indicates that the privder does not support dots in bucket names and how dots should be encoded")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.defaultRegion, storageProvider.defaultRegion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultRegion, disabledAsDestination, dotEncode, endpoint, id, multiRegional, name, portHttp, portHttps, productName, protocol, regions, supportsHttp, supportsHttps);
  }
