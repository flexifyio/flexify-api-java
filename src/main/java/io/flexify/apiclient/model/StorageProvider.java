...
public class StorageProvider {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultRegion, disabledAsDestination, dotEncode, endpoint, id, name, portHttp, portHttps, productName, protocol, regions, supportsHttp, supportsHttps);
  }
