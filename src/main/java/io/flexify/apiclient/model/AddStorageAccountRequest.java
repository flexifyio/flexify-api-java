...
public class AddStorageAccountRequest {
  ...
  @JsonProperty("verifyKeys")
  private Boolean verifyKeys = null;
  ...
  **/
  ...
  public AddStorageAccountRequest addIncludeBucketsItem(String includeBucketsItem) {
   ...
   /**
   * Lists of buckets to start monitoring
   * @return includeBuckets
  **/
  @ApiModelProperty(value = "Lists of buckets to start monitoring")
  ...
  **/
  ...
  public AddStorageAccountRequest verifyKeys(Boolean verifyKeys) {
    this.verifyKeys = verifyKeys;
    return this;
  }

   /**
   * If set to true, storage account keys will be verified before adding storage
   * @return verifyKeys
  **/
  @ApiModelProperty(example = "false", value = "If set to true, storage account keys will be verified before adding storage")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.storageAccount, addStorageAccountRequest.storageAccount) &&
        ...
        Objects.equals(this.verifyKeys, addStorageAccountRequest.verifyKeys) &&
        Objects.equals(this.refresh, addStorageAccountRequest.refresh);
  }

  @Override
  public int hashCode() {
    return Objects.hash(storageAccount, includeBuckets, endpointId, putObjects, verifyKeys, refresh);
  }
  ...
  public String toString() {
    ...
    sb.append("    verifyKeys: ").append(toIndentedString(verifyKeys)).append("\n");
